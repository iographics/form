...
(function (root, factory) {
  ...
  function _setProgress(targetElement) {
    ...
    if (this._options.overlayMode && targetElement.tagName.toLowerCase() === 'body') {
      ...
      progressElementContainer.style.width = (this._options.width || targetElementOffset.width + 'px');
      progressElementContainer.style.height = (this._options.height || '2px');
    ...
    containerElement.appendChild(progressElementContainer);
